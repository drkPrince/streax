            ...
            <BrowserRouter>
                <Route exact path='/'>
                    <nav className="flex justify-between px-20 items-center pt-12 pb-3" >
                        <h1 className='text-2xl bold text-transparent bg-clip-text tracking-wide bg-gradient-to-r from-gray-500 to-gray-400 flex items-center'>
                            Streax
                            <svg className='fill-current text-gray-400 mx-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="29"><path fill="none" d="M0 0H24V24H0z"/><path d="M21 3v2c0 9.627-5.373 14-12 14H5.243C5.08 19.912 5 20.907 5 22H3c0-1.363.116-2.6.346-3.732C3.116 16.974 3 15.218 3 13 3 7.477 7.477 3 13 3c2 0 4 1 8 0zm-8 2c-4.418 0-8 3.582-8 8 0 .362.003.711.01 1.046 1.254-1.978 3.091-3.541 5.494-4.914l.992 1.736C8.641 12.5 6.747 14.354 5.776 17H9c6.015 0 9.871-3.973 9.997-11.612-1.372.133-2.647.048-4.22-.188C13.627 5.027 13.401 5 13 5z"/></svg>
                        </h1>
                        <div className="flex space-x-4">
                            <div className='flex hover:bg-green-900 transition-all duration-300 hover:text-white px-3 py-1 text-sm rounded-full text-gray-100 '>
                                ...
                                <button onClick={()=>setModal(true)} className='text-sm'>Add Habit</button>
                            </div>
                            <div className='flex hover:bg-indigo-700 transition-all duration-300 hover:text-white px-3 py-1 text-sm rounded-full text-gray-400 '>
