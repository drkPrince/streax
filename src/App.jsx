...
export default function App() 
{
    ...
    return user ? 
        <div className="overflow-hidden min-h-screen" style={{background: 'var(--main-bg)'}}>
            <BrowserRouter>
                <Route exact path='/'>
                    <nav className="flex justify-between px-4 md:px-20 items-center pt-8 md:pt-12 pb-3" >
                        <h1 className='text-xl md:text-2xl bold text-transparent bg-clip-text tracking-wide bg-gradient-to-r from-red-600 to-red-300 flex items-center '>
                            strx
