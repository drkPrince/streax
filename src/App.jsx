                ...
                <Route exact path='/'>
                    <nav className="flex justify-between px-4 md:px-20 items-center pt-6 md:pt-12 pb-3" >
                        ...
                        <div className="flex space-x-1 md:space-x-4">
                            <div onClick={logOut} className='flex hover:bg-red-700 transition-all duration-300 hover:text-white px-3 py-1 text-sm rounded-full text-gray-400 items-center'>
