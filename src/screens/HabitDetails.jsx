		...
		<div>
			...
			<div className="grid grid-cols-3 gap-x-2 mt-12 md:mt-20 text-center">
				<div>
					...
					<h1 className={`${text} text-3xl md:text-7xl`}>{habit.currentStreak} </h1>
				</div>
				<div>
					<h1 className='text-gray-300 text-xs md:text-sm uppercase tracking-wide md:tracking-widest bold flex flex-col sm:flex-row items-center  justify-center'>
					...
					<h1 className={`${text} text-3xl md:text-7xl`}>{habit.longestStreak}</h1>
				</div>
				<div>
					<h1 className='text-gray-300 text-xs md:text-sm uppercase tracking-wide md:tracking-widest bold flex flex-col sm:flex-row items-center  justify-center'>
					...
					<h1 className={`${text} text-3xl md:text-7xl`}>{habit.completedOn.length}</h1>
				</div>
			</div>
			<div className='mt-12'>
