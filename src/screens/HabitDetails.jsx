		...
		<div>
			<div className="flex justify-between items-center">
				<div className='text-gray-200'>
					<h1 className='text-5xl text-transparent bg-clip-text bg-gradient-to-r from-red-100 to-blue-100 py-4'>{habit.name}</h1>
				</div>
			...
			<div className="flex justify-between mt-20 text-center">
				<div>
					<h1 className='text-gray-300 text-sm uppercase tracking-widest bold flex items-center'>
